module.exports = (app) => {
  ...
  const controller = require('../controllers/admin/customer-staff-controller.js')

  router.get('/get-staff', [authCookie.verifyUserCookie], controller.getStaff)
  ...
  app.use('/api/admin/customer-staffs', router)
}
